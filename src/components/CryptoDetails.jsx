        ...
        {coinData ? (
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  <a target={"_blank"} rel="noreferrer" className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded" href={coinData?.links?.homepage[0]}>{coinData?.links?.homepage[0].substring(0,30)}</a>
                  <a target={"_blank"} rel="noreferrer" className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded" href={coinData?.links?.blockchain_site[0]}>{coinData?.links?.blockchain_site[0].substring(0,30)}</a>

                  {
                    coinData?.links?.official_forum_url &&
                  <a target={"_blank"} rel="noreferrer" className="text-sm bg-gray-200 text-gray-100 px-1.5 py-0.5 my-1 rounded" href={coinData?.links?.official_forum_url[0]}>{coinData?.links?.official_forum_url[0].substring(0,30)}</a> 
                  }
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">  
                    <div
                      ...
                      <span>
                        {Number(
                          coinData.market_data.sentiment_votes_down_percentage
                        ).toFixed(2)}{" "}
                        %
                      </span>
                      <svg
            ...
            <div className="absolute bottom-8 right-8 flex items-center  gap-3">
              {
                coinData.links.repos_url.github[0] && <a target={"_blank"} rel="noreferrer" href={coinData.links.repos_url.github[0]}>
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {
                coinData.links.twitter_screen_name && <a target={"_blank"} rel="noreferrer" href={`https://twitter.com/${coinData.links.twitter_screen_name}`}>
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {
                coinData.links.subreddit_url &&  <a target={"_blank"} rel="noreferrer" href={coinData.links.subreddit_url}>
                      <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
              ...
              {
               coinData.links.facebook_username && <a target={"_blank"} rel="noreferrer" href={`https://facebook.com/${coinData.links.facebook_username}`}>
                 <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
                    height="1em"
