...
const Saved = () => {
  ...
  return (
    <section className="w-full max-w-screen-lg mx-auto h-full flex flex-col mt-16 mb-24 relative px-4">
      <div className="w-full min-h-[60vh] py-8 border border-gray-100 rounded">
        ...
        <button
          ...
          absolute right-0 -top-10 sm:right-4 sm:-top-8"
        ...
        >
          ...
          >
            ...
            <path fill="rgba(0,0,0,0)" d="M12 15c1.671 0 3-1.331 3-3s-1.329-3-3-3-3 1.331-3 3 1.329 3 3 3z" />
          </svg>
        </button>
      </div>
    </section>
